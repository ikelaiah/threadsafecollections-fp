...
> **Historical release snapshot.** This document records v0.8.1 and may contain
> older APIs, measurements, toolchains, or support statements. Use the
> [current documentation](../index.md) for the present checkout.

**Audience:** users researching the v0.8.1 release and project maintainers.
...
- **Documentation**: See [../index.md](../../README.md)
