...
> **Historical release snapshot.** This document records v0.8.3 and may contain
> older APIs, measurements, toolchains, or support statements. Use the
> [current documentation](../index.md) for the present checkout.

**Audience:** users researching the v0.8.3 release and project maintainers.
...
Added [docs/../start/cheat-sheet.md](../start/cheat-sheet.md), a generated quick reference covering:
...
- **Generated Cheat Sheet**: [docs/../start/cheat-sheet.md](../start/cheat-sheet.md)
